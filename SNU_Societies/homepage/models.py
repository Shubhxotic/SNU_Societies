...
class Clubs(models.Model):
    ...
    contactEmail = models.EmailField(max_length=50, default="")
    Description = models.CharField(max_length=3200, default="")
    oneliner=models.CharField(max_length=200, default="")

class eve_detail(models.Model):
    Name = models.CharField(max_length=32)
    Club_Name = models.CharField(max_length=32, default="Unknown Club")
    Description = models.CharField(max_length=6000, default="", null=True)
    ...
    HostSpeakers = models.CharField(null=True, max_length=100, default="")
    interests = models.CharField(max_length=3200, default="")
